...
public class Figo extends Car {
	...
	public void accelerate() {
		System.out.println("Figo accelerating");
	}
	
	@Override
	public void accelerate(boolean reverse) {
		System.out.println("Figo accelerating on reverse gear");
	}

	@Override
	public void applyBreak() {
		System.out.println("Figo applying break");
	}

	@Override
	public void changeGearToUp() {
		System.out.println("Figo change gear up");
	}
